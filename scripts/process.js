...
fs.readFile(`${__dirname}/data.json`, 'utf-8', (err, data) => {
  ...
  fs.writeFile(`${__dirname}/ages.json`, JSON.stringify(ages), (saveErr2) => {
    if (saveErr2) {
  ...
  fs.writeFile(`${__dirname}/numOs.json`, JSON.stringify(numOs), (saveErr6) => {
    if (saveErr6) {
