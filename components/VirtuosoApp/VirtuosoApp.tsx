  ...
  return (
    ...
    >
      <header className={css.header}>
        {/* isExternalUrl={true} because client routing between website and virtuoso seems to reload some css files in production. This causes visible changes due to a change in css loading order. */}
        <DXLabLogo href={'/'} isExternalUrl={true} className={css.dxlabLogo} />
